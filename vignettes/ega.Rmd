...
The built-in dataset `glucose_data` contains sample paired glucose values for 5072 patients. The function `getClarkeZones` will assign Clarke zones:
...
For this particular dataset, 71.6+23+1 = 95.6% of pairs fall within the clinically acceptable zones A-C. 
